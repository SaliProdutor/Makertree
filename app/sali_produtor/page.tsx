          ...
          <header>
            <div className="flex gap-10 items-center bg-gray-600 px-8 py-5 ">
              ...
              >
                ...
                <Image width={60} height={60} className=" w-[5rem] h-[5rem] object-cover bg-cover rounded-full border-blue border-solid border border-lg p-[.2rem]" src={photo} alt="Foto"/>
              </motion.div>
              <div>
                <motion.h1
                  initial={{ opacity: 0, y: 10 }}
